...
export function CardHeader({
  ...
  return (
    <div className={cx('mb-3 flex flex-col gap-1.5', className)} {...props} />
  );
}
...
export function CardDescription({
  ...
  return (
    <p
      className={cx('text-sm text-[var(--color-text-secondary)]', className)}
      {...props}
    />
  );
}
...
export function CardContent({
  ...
  return (
    <div
      className={cx('text-sm text-[var(--color-text-primary)]', className)}
      {...props}
    />
  );
}
