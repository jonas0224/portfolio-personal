    ...
    <div className="md-content portfolio-markdown">
      <ReactMarkdown
        ...
        components={{
          ...
          ul({ children }) {
            return (
              <ul className="my-4 list-disc space-y-2 pl-6 text-[var(--slate)]">
                {children}
              </ul>
            );
          },
          ol({ children }) {
            return (
              <ol className="my-4 list-decimal space-y-2 pl-6 text-[var(--slate)]">
                {children}
              </ol>
            );
          },
          ...
          td({ children }) {
            return (
              <td className="border border-[var(--lightest-navy)] px-3 py-2">
                {children}
              </td>
            );
          },
